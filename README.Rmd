...
The tabName linked to each menuSubItem should be named after the module id.
Here is an example how to access the administration console from the menuSubItem:
