...
The goal of kitems is to provide a framework to manage tabular 
*items* and a set of tools to implement it within R Shiny web applications.
...
Version 0.8.x requires a data model migration from previous versions as well as some
modification in your app.

Check this [article](https://thekangaroofactory.github.io/kitems/articles/migration.html) 
to get the detailed procedure.

## Lifecycle

See this [article](https://thekangaroofactory.github.io/kitems/articles/roadmap.html) to get more information about the package roadmap.
