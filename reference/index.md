...
- [`dm_delete()`](https://thekangaroofactory.github.io/kitems/reference/dm_delete.md)
  : Delete data model
- [`dm_delete_preview()`](https://thekangaroofactory.github.io/kitems/reference/dm_delete_preview.md)
  : Data model delete preview modal
- [`dm_display()`](https://thekangaroofactory.github.io/kitems/reference/dm_display.md)
  : Data Model Display
- [`dm_integrity()`](https://thekangaroofactory.github.io/kitems/reference/dm_integrity.md)
  : Check data model integrity
- [`dm_mask()`](https://thekangaroofactory.github.io/kitems/reference/dm_mask.md)
