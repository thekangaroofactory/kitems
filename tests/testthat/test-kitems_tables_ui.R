...
test_that("items_filtered_view_DT works", {
  ...
  # -- test output
  expect_equal(unlist(x), c(name = "div", attribs.id = "data-filtered_view", attribs.style = "width:100%; height:auto; ", attribs.class = "datatables html-widget html-widget-output"))
