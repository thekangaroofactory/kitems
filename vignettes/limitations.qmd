...
-   Prior to R-4.3.0, `attribute_values()` function may raise an error when the first element of a POSIXct vector set as `value` parameter is `NA`. This is due to missing origin in the call to as.POSIXct.
