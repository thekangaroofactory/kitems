...
#'
#' @details
#' `refresh()` and `freeze()` are setter functions that allow to add or remove
#' attributes from the refreshed ones.
#' `refreshed()` and `frozen()` are getter functions to quickly access the skipped
#' attributes that are refreshed or not during an item update.
#'
